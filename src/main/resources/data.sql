-- Insere todos os 12 produtos na tabela PRODUTO
-- Os IDs serão gerados automaticamente (1 a 12)
...
-- Variações para Produto ID 4 (Bolsa Tote Terracota)
...
-- Variações para os Acessórios (Produto ID 6 a 12)
INSERT INTO VARIACAO (cor, imagem, produto_id) VALUES ('Madeira', 'imagens/colar3.png', 6);
INSERT INTO VARIACAO (cor, imagem, produto_id) VALUES ('Prata', 'imagens/colar1.png', 7);
INSERT INTO VARIACAO (cor, imagem, produto_id) VALUES ('Dourado', 'imagens/colar2.png', 8);
INSERT INTO VARIACAO (cor, imagem, produto_id) VALUES ('Couro', 'imagens/pulseira1.png', 9);
INSERT INTO VARIACAO (cor, imagem, produto_id) VALUES ('Dourado', 'imagens/pulseira2.png', 10);
INSERT INTO VARIACAO (cor, imagem, produto_id) VALUES ('Turquesa', 'imagens/brinco1.png', 11);
INSERT INTO VARIACAO (cor, imagem, produto_id) VALUES ('Cobre', 'imagens/brinco2.png', 12);


-- Insere o usuário de teste (SEM forçar o ID)
INSERT INTO USUARIOS (nome, email, senha) VALUES ('Usuário Teste', 'teste@teste.com', '123');


-- Insere os posts de exemplo na tabela POST
-- [CORREÇÃO APLICADA AQUI: aspas simples 'slow fashion' escapadas para ''slow fashion'']
